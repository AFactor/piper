...
namespace Tesco.Com.Pipeline.Controllers
{
    ...
    /// </summary>
    public class ProductControllerETL : ApiController
    {
        ...
        public ProductControllerETL() { }
        public ProductControllerETL(IProductProvider product, IPriceProvider price, IPromotionProvider promos)
        {
